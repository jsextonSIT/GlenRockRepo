<?PHP
	...
	function getCategory($con)
	{
		...
		$where = " WHERE b.Business_ID = bcat.businessID AND bcat.businessCatID = bcategory.businessCatID AND bcategory.businessCatID = 9"; 
	...
	{
		$server_response["medical"] = $category;
