<?PHP
	...
	function getCategory($con)
	{
		...
		$where = " WHERE b.Business_ID = bcat.businessID AND bcat.businessCatID = bcategory.businessCatID AND bcategory.businessCatID = 12"; 
	...
	{
		$server_response["retail"] = $category;
