		...
		gridview.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
				...
				*****/
				...
				//TODO: Create ArrayList of TrashEventArticles, one for each event taking place on this date.
//				TrashEventArticle article;
//				int artId;
...
//				}
		...
		ArrayList<TrashEventArticle> ceas = new ArrayList<TrashEventArticle>();
		ceas = ((MainActivity)getActivity()).getTrashEventArticles();
		showTrashEvents(ceas);
