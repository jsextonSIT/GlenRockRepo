<?PHP
	...
	function getCategory($con)
	{
		...
		$where = " WHERE b.Business_ID = bcat.businessID AND bcat.businessCatID = bcategory.businessCatID AND bcategory.businessCatID = 5"; 
	...
	{
		$server_response["proServices"] = $category;
